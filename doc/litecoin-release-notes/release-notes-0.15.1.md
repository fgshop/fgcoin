Fgcoin Core version *0.15.1* is now available from:

  <https://download.fgcoin.org/fgcoin-0.15.1/>
...
A number of changes to the way Fgcoin Core deals with peer connections and invalid blocks
