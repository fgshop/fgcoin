...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 5000000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("seed-a.fgcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.fgcointools.com");
        vSeeds.emplace_back("dnsseed.fgcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 293345, 0x1e0ffff0, 1, 5000000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.fgcointools.com");
        vSeeds.emplace_back("seed-b.fgcoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 0, 0x207fffff, 1, 5000000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
